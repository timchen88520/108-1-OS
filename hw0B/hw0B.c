...
int printTemp() {
	...
	temp1 = fopen("/sys/class/hwmon/hwmon5/temp1_input", "r");
	assert(temp1 != NULL);
	temp2 = fopen("/sys/class/hwmon/hwmon5/temp2_input", "r");
	assert(temp2 != NULL);
	temp3 = fopen("/sys/class/hwmon/hwmon5/temp3_input", "r");
	assert(temp3 != NULL);
	temp4 = fopen("/sys/class/hwmon/hwmon5/temp4_input", "r");
	assert(temp4 != NULL);
